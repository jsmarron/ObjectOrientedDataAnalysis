disp('Running MATLAB script file OODAfig3p2.m') ;
%
%    Makes Figure 3.2 of the OODA book,
%    Simple 2-d Toy Example
%    Raw Data & Mean & EV1 
%
%    Copied from OODAbookChpBFigB.m
...
mpev1line = meigvec(:,1) * mpc(1,:) + vmean * ones(1,n) ;
mpev1linew = [mpev1line(1,:); mpev1line(1,:); 
                  mpev1line(end,:); mpev1line(end,:)] ;
