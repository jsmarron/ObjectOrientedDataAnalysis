disp('Running MATLAB script file OODAfig5p9.m') ;
%
%    Makes graphic similar to Figure 5.9 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigG.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Cleaned data, Marginal Distribution Plot, Skewness
%
