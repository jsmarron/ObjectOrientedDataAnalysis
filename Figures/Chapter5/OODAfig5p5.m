disp('Running MATLAB script file OODAfig5p5.m') ;
%
%    Makes graphic similar to Figure 5.5 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigC.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Raw data, Marginal Distribution Plot, S.D.
%
