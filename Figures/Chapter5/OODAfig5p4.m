disp('Running MATLAB script file OODAfig5p4.m') ;
%
%    Makes graphic similar to Figure 5.4 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigB.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Raw data, Marginal Distribution Plot, Mean
%
