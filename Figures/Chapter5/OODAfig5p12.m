disp('Running MATLAB script file OODAfig5p12.m') ;
%
%    Makes graphic similar to Figure 5.12 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigJ.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Cleaned data, Binary only, PCA scores scatterplot matrix
%
...
%  Get binary data
d = sum(flagbin) ;
disp(['Kept ' num2str(d) ' binary variables']) ;
mdata = mdata(flagbin,:) ;
