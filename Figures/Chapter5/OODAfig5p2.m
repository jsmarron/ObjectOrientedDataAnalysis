disp('Running MATLAB script file OODAfig5p2.m') ;
%
%    Makes graphic similar to Figure 5.2 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpBFigF.m
%    in:        OODAbook\ChapterB
%
%    Spanish Male Mortality Data:
%        Marginal distribution plot, log10 data
%
...
paramstruct = struct('istat',1, ...
                     ...
                     'datovlaymax',0.7, ...
                     'datovlaymin',0.3) ;
MargDistPlotSM(fliplr(log10(tmdata)),paramstruct) ;
