disp('Running MATLAB script file OODAfig5p10.m') ;
%
%    Makes graphic similar to Figure 5.10 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigH.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Cleaned data, Marginal Distribution Plot, Number Unique
%
