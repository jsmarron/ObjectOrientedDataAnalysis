disp('Running MATLAB script file OODAfig5p11.m') ;
%
%    Makes graphic similar to Figure 5.11 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigI.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Cleaned data, Marginal Distribution Plot, Number Most Frequent
%
