disp('Running MATLAB script file OODAfig5p6.m') ;
%
%    Makes graphic similar to Figure 5.6 for Chapter 5 of the OODA book,
%
%    Modified version of:  OODAbookChpDFigD.m
%    in:        OODAbook\ChapterD
%
%    Drug Discovery Data:
%        Raw data, Marginal Distribution Plot, Mean, First 8
%
