disp('Running MATLAB script file OODAfig11p4.m') ;
%
%    Makes Figure 11.4 of the OODA book,
%    Nonparametric Derivation of MDP
%
...
mresid1 = data1' - vec2matSM(vmean,n) ;
mresid2 = data2' - vec2matSM(vmean,n) ;
