disp('Running MATLAB script file OODAfig6p11.m') ;
%
%    Makes Figure 6.11 of the OODA book,
%    Combo View, Twin Arches Data, 1st Mode of Variation
%
