disp('Running MATLAB script file OODAfig17p8.m') ;
%
%    Makes Figure 17.8 of the OODA book,
...
viewang2 = 170 ;    %  2nd view angle in degrees (currently not used)
